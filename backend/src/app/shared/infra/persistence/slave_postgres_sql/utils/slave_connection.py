...
def create_db_engine(config: Optional[SlaveDatabaseConfig] = None) -> Engine:
...
slave_config = SlaveDatabaseConfig()
slave_connection_engine = create_db_engine(slave_config)
